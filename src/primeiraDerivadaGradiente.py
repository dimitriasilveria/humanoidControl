...
#----------------------------------------------------------
    ...
    [pa,pb,pc,M,ponto] = trajetoria(Y,X0) #cálculo dos pontos da trajetória
    #pa - ponto do pé A
    #pb - ponto do pé B
...
#----------------------------------------------------------
    ...
    Y = U0
    Y[ind,0] = y
    [pa,pb,pc,M,ponto] = trajetoria(Y,X0) #tive de acrescentar as variáveis M e ponto, pois a função trajetória 
